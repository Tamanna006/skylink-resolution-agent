...
**Demo Video:**(https://drive.google.com/file/d/1SJZS8eA_gjEcokyqN9cew8e3EKpwhDvy/view?usp=drive_link)
...
The deployed Vercel version works without requiring any local setup.
...
- CSS3
- JavaScript
- Browser-based customer chat interface
- Customer context and scenario selection
- Decision rail
- Policy view
- Audit trail
- Case-record export
...
This prototype does not use a separate backend server.

The application uses a client-side JavaScript policy engine because the assignment provides a limited set of customers, bookings and service rules. This keeps the prototype lightweight, portable and easy to evaluate.

No external database or payment/reservation backend is connected to the prototype.

### Deployment and Version Control

- **GitHub** — source-code management and assignment submission
- **Vercel** — deployment of the live prototype
...
2. The request is mapped to one or more structured intent types.
3. Customer and booking information is loaded from the grounding data.
4. The policy engine evaluates the request against the applicable rules.
5. A verdict is produced:
   - `execute`
   - `decline`
   - `escalate`
   - `ask`
6. The corresponding action or escalation is recorded.
7. A customer-facing response is generated from the decision.
8. The conversation and audit trail are updated.
...
**Demo Video:**  
https://drive.google.com/file/d/1SJZS8eA_gjEcokyqN9cew8e3EKpwhDvy/view?usp=drive_link
